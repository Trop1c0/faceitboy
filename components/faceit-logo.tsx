...
/**
 * Official FACEIT wordmark. The wordmark uses currentColor so it can be themed,
 * while the signature "spark" over the I stays FACEIT orange.
 */
export function FaceitLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 122 18"
